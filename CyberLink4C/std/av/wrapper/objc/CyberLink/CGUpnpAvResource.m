...
- (NSString *)bitrate
{
	return [self attributeValueForName:@"bitrate"];
}
- (NSString *)duration
{
  	return [self attributeValueForName:@"duration"];
}
...
{
	CGSize1 selfResouceSize = [self resolution];
    CGSize1 otherResourceSize = [otherResource resolution];
